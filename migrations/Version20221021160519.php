...
final class Version20221021160519 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment_reply (id INT AUTO_INCREMENT NOT NULL, comment_id INT NOT NULL, user_id INT NOT NULL, message LONGTEXT NOT NULL, create_timestamp INT NOT NULL, update_timestamp INT NOT NULL, INDEX IDX_54325E11F8697D13 (comment_id), INDEX IDX_54325E11A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

...
final class Version20221016121049 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE repository ADD active TINYINT(1) NOT NULL, ADD update_revisions_interval SMALLINT NOT NULL, ADD update_revisions_timestamp INT NOT NULL');

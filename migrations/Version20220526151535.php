 ...
 */
final class Version20220526151535 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE external_link (id INT AUTO_INCREMENT NOT NULL, rule_id INT NOT NULL, pattern VARCHAR(255) NOT NULL, url VARCHAR(255) NOT NULL, INDEX IDX_A3B3F9DD744E0351 (rule_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rule_options (id INT AUTO_INCREMENT NOT NULL, rule_id INT NOT NULL, diff_algorithm ENUM(\'patience\', \'minimal\', \'histogram\', \'myers\') NOT NULL COMMENT \'(DC2Type:enum_diff_algorithm)\', ignore_space_at_eol TINYINT(1) DEFAULT 1 NOT NULL, ignore_space_change TINYINT(1) DEFAULT 0 NOT NULL, ignore_all_space TINYINT(1) DEFAULT 0 NOT NULL, ignore_blank_lines TINYINT(1) DEFAULT 0 NOT NULL, subject VARCHAR(255) DEFAULT NULL, theme VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_20A1C333744E0351 (rule_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

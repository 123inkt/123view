...
final class Version20221201212737 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE code_review_activity (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, review_id INT NOT NULL, event_name VARCHAR(255) NOT NULL, data JSON DEFAULT NULL, create_timestamp INT NOT NULL, INDEX IDX_D215A294A76ED395 (user_id), INDEX IDX_D215A2943E2E969B (review_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

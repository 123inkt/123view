...
final class Version20221015125044 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE revision (id INT AUTO_INCREMENT NOT NULL, repository_id INT NOT NULL, review_id INT DEFAULT NULL, commit_hash VARCHAR(50) NOT NULL, title VARCHAR(255) NOT NULL, author_email VARCHAR(255) NOT NULL, author_name VARCHAR(255) NOT NULL, create_timestamp INT NOT NULL, INDEX IDX_6D6315CC50C9D4F7 (repository_id), INDEX IDX_6D6315CC3E2E969B (review_id), INDEX create_timestamp_idx (create_timestamp), UNIQUE INDEX repository_commit_hash (repository_id, commit_hash), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

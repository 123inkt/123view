 ...
 */
final class Version20231110213146 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rule_notification ADD `read` TINYINT(1) DEFAULT 0 NOT NULL');
        $this->addSql(
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rule_notification DROP `read`');
    }
}

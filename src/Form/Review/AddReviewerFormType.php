...
{
    public function __construct(private UrlGeneratorInterface $urlGenerator, private UserRepository $userRepository, private UserService $userService)
    {
    }
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        if (count($choices) > 0) {
            $builder->add('user', ChoiceType::class, [
                ...
                'choices'                   => $choices,
                'preferred_choices'         => [$this->userService->getCurrentUser()],
                'multiple'                  => false,
                'expanded'                  => false,

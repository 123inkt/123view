 ...
 *     traceid?: array{
 *         request_header?: scalar|Param|null, // The header in which the bundle will look for and set trace IDs // Default: "X-Trace-Id"
 *         response_header?: scalar|Param|null, // The header the bundle will set the trace ID at in the response // Default: "X-Trace-Id"
 *         generator_service?: scalar|Param|null, // The service name for the trace ID generator. Defaults to `symfony/uid` or `ramsey/uuid`
 *     },
 *     request?: array{
 *         trust_header?: bool|Param, // Whether or not to trust the incoming request's headers as a real TraceID // Default: true
 *         trusted_ips?: scalar|Param|null, // Only trust incoming request's headers if the request comes from one of these IPs (supports ranges/masks). Accepts a string-array, comma separated string or null. Defaults to null, accepting all request IPs. // Default: null
 *     },
 *     response?: array{
 *         send_header?: bool|Param, // Whether or not to send a response header with the trace ID. Defaults to true // Default: true
 *         trusted_ips?: scalar|Param|null, // Only send response if the request comes from one of these IPs (supports ranges/masks) Accepts a string-array, comma or pipe separated string or null. Defaults to null, accepting all request IPs. // Default: null
 *     },
 *     storage_service?: scalar|Param|null, // The service name for trace ID storage. Defaults to `TraceStorage`
 *     monolog?: array{
 *         enabled?: bool|Param, // Whether or not to turn on the trace ID processor for monolog // Default: true
 *     },
 *     console?: array{
 *         enabled?: bool|Param, // Whether to add the trace id to console commands, defaults to true // Default: true
 *         trace_id?: scalar|Param|null, // Option to set the `Trace-Id` to use for console commands from env var. Defaults to null. // Default: null
 *     },
 *     messenger?: array{
 *         enabled?: bool|Param, // Whether to add the trace id to message bus events, defaults to true // Default: true
 *     },
 *     twig?: array{
 *         enabled?: bool|Param, // Whether or not to enable the twig `trace_id()` and `transaction_id()` functions. Only works if TwigBundle is present. // Default: true
 *     },
 *     http_client?: array{
 *         enabled?: bool|Param, // Whether or not to enable the trace id aware http client // Default: true
 *         tag_default_client?: bool|Param, // Whether or not to tag the default http client // Default: false
 *         header?: scalar|Param|null, // The header the bundle set in the request in the http client // Default: "X-Trace-Id"
 *     },
 *     sentry?: array{
 *         enabled?: bool|Param, // Whether or not to enable passing trace and transaction id to Sentry. Note: ensure to set $sentry->tracing->enabled(false) to disable Sentry's own tracing. // Default: false
 *         hub_service?: scalar|Param|null, // The service id of the Sentry Hub. Defaults to Sentry\State\HubInterface // Default: "Sentry\\State\\HubInterface"
 *     },
 * }

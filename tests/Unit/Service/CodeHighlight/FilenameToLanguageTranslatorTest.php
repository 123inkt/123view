...
class FilenameToLanguageTranslatorTest extends AbstractTestCase
{
    ...
    public static function dataProvider(): array
    {
        return [
            ...
            "mjs"         => ["/path/to/file.mjs", "javascript"],
            "jsx"         => ["/path/to/file.jsx", "javascript"],
            ...
            "tsx"         => ["/path/to/file.tsx", "typescript"],
            "mts"         => ["/path/to/file.mts", "typescript"],
            "cts"         => ["/path/to/file.cts", "typescript"],

...
return [
    ...
    'add.ai.review.reference'                     => 'Add AI review reference',
    'advanced'                                    => 'Advanced',
    'ai.review.already.requested'                 => 'AI review already requested, can only be requested once per review (for now)',
    'ai.review.completed.failure'                 => 'The AI code review completed unsuccessfully',
    'ai.review.completed.no.files'                => 'No suitable files found for AI code review',
    'ai.review.completed.partial'                 => 'The AI code review completed for some files only, see the review timeline for details',
    'ai.review.completed.success'                 => 'The AI code review completed successfully',
    'ai.review.instructions'                      => 'Additional project-specific review instructions',
    'ai.review.instructions.successful.saved'     => 'AI review instructions successfully saved',
    'ai.review.reference.matcher.new'             => 'Add matcher',
    'ai.review.reference.matcher.successful.removed' => 'Matcher successfully removed',
    'ai.review.reference.matcher.successful.saved'   => 'Matcher successfully saved',
    'ai.review.reference.matchers'                => 'Matchers',
    'ai.review.reference.new'                     => 'Create new AI review reference',
    'ai.review.reference.section.new'             => 'Add section',
    'ai.review.reference.section.successful.removed' => 'Section successfully removed',
    'ai.review.reference.section.successful.saved'   => 'Section successfully saved',
    'ai.review.reference.sections'                => 'Sections',
    'ai.review.reference.successful.removed'      => 'AI review reference successfully removed',
    'ai.review.reference.successful.saved'         => 'AI review reference successfully saved',
    'ai.review.references'                        => 'AI review references',
    ...
    'code.marker'                                 => 'Code marker (optional regex)',
    'code.search'                                 => 'Code search',
    'code.search.disclaimer'                      => 'Disclaimer: only searches in the main branch of active repositories',
    'comment.draft.label'                         => 'Draft',
    'comment.is.draft'                            => 'Cannot reply to a draft comment.',
    ...
    'draft.comments'                              => 'Drafts',
    'draft.comments.empty'                        => 'You have no draft comments.',
    'draft.comments.overview'                     => 'Comment drafts',
    'edit.comment'                                => 'Edit comment',
    'edit.ai.review.reference'                    => 'Edit AI review reference',
    ...
    'favorite'                                    => 'Favorite',
    'file'                                        => 'File',
    'file.pattern'                                => 'File pattern (glob)',
    ...
    'git.sync'                                    => 'Gitlab sync',
    'git.sync.disable'                            => 'Disable sync',
    'git.sync.disabled'                           => 'Sync comments and approvals is disabled',
    ...
    'gitlab.comment.sync.disabled'                => 'Success. Comments and approvals will no longer be synced to Gitlab.',
    'gitlab.comment.sync.enabled'                 => 'Success. Comments and approvals will be synced to Gitlab from now on.',
    ...
    'rule.duplicate.confirmation.message'         => 'Are you sure you want to make a copy of this rule?',
    'rule.duplicate.title'                        => 'Make a copy of this rule',
    ...
    'timeline.review.ai_coverage_incomplete'      => 'AI code review completed for {reviewedCount} file(s); {skippedCount} file(s) were too large to review and {failedCount} file(s) failed.',
    ...
    'configure.mcp.server'                        => 'See how to configure the MCP server at',
